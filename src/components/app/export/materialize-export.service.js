app.service('materializeExportService', [
	...
	function(THEME_PALETTES, COLOR_VALUES) {
		...
		var SCSS_END = [
			...
			'$collection-border-color: $bg-color-dark;',
			'$collection-bg-color: $bg-color-light;',
			'$collection-hover-bg-color: $bg-color-dark-2;',
			'$chip-bg-color: $bg-color-dark-2;',
			...
			'.modal-overlay { background-color: $bg-color-dark; }',
			...
			'{ background-color: $bg-color-dark-2; border-color: $bg-color-dark-2; }',
